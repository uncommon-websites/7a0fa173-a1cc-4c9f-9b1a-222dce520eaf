...
<nav class="fixed top-0 left-0 right-0 z-50 transition-all duration-300 {isScrolled ? 'bg-black/80 backdrop-blur-md py-4' : 'bg-transparent py-6'}">
    <div class="container mx-auto px-6 flex items-center justify-between">
        <!-- Logo -->
        <a href="/" class="flex items-center gap-3 text-white font-semibold text-xl tracking-tight">
        ...
        <div class="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
            <a href="#" class="hover:text-white transition-colors">Hosting</a>
            <a href="#" class="hover:text-white transition-colors">Plugins</a>
            <a href="#" class="hover:text-white transition-colors">Agency</a>
            <a href="#" class="hover:text-white transition-colors">Resources</a>
            <a href="#" class="hover:text-white transition-colors">About</a>
        </div>

        <!-- CTA -->
        <a href="#" class="hidden md:flex items-center gap-1 text-sm font-medium text-white hover:text-[var(--color-tangible-primary)] transition-colors">
            Get Started
